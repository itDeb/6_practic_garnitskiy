package com.garnitskiy.notebook;
...
import ru.mirea.garnitskiy.notebook.R;
...
public class MainActivity extends AppCompatActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        @SuppressLint("SdCardPath") String pathh = "/data/data/ru.mirea.garnitskiy.notebook/files/fileName.txt";
    ...
    public void onSaveText(View view) throws IOException {
        ...
        @SuppressLint("SdCardPath") String path = "/data/data/ru.mirea.garnitskiy.notebook/files/"+fileName;
